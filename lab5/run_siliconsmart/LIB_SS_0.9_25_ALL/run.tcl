...
set_location /home/linux/ieng6/cs241asp25/cs241asp25bu/lab5/run_siliconsmart/LIB_SS_0.9_25_ALL
import -liberty ./ref.lib -overwrite -netlist_dir ./netlists -ext .cdl $cell_list
configure  -power -timing
characterize
model -recharacterize -timing -power -liberty -operating_condition SS_0.9_25_ALL -library_type best -output SS_0.9_25_ALL
