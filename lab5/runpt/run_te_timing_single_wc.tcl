...
exec echo "Single WC path"
report_timing -slack_lesser_than 1.0 -sig 6 -path_type full_clock -transition_time -nets -capacitance -start_end_pair > wc_top10_worst_paths.rpt
