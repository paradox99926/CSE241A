...
# set_operating_conditions -analysis_mode single
...
exec echo "OCV path"
report_timing -slack_lesser_than 1.0 -sig 6 -path_type full_clock -transition_time -nets -capacitance -start_end_pair > ocv_top10_worst_paths.rpt
...
exec echo "OCV end points"
report_timing -slack_lesser_than 1.0 -to $endpoints -max_paths [sizeof_collection $endpoints] -path_type end -nosplit > ocv_end_point_timing.rpt
