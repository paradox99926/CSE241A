...
# set_operating_conditions -analysis_mode on_chip_variation
...
exec echo "single BC path"
report_timing -slack_lesser_than 1.0 -sig 6 -path_type full_clock -transition_time -nets -capacitance -start_end_pair > bc_top10_worst_paths.rpt
...
exec echo "single BC End points"
