    ...
    for {set iter 1} {$iter <= 2} {incr iter} {
        ...
        foreach_in_collection cell_instance $cellList {
            ...
            foreach_in_collection output_pin [getFanOutPins $cellName $outCap] {
                ...
                set adjust_max_allowed_load [expr {$maxCap_ratio*$max_allowed_load}]
                ...
                while {1.0*$current_load > $adjust_max_allowed_load} {
                    ...
                    if {1.0*$current_load <= $adjust_max_allowed_load} {
